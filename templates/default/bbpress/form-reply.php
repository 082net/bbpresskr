...
// add_filter( 'bbp_use_wp_editor', '__return_false', 88.888 );
?>
...
<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
	...
	<div id="bbpkr-respond" class="bbp-reply-form bbpkr-reply-form">
		<h3 id="bbpkr-reply-title" class="bbpkr-reply-reply-title"><?php printf( __( 'Reply To: %s', 'bbpresskr' ), bbp_get_topic_title() ); ?> <small><?php bbp_cancel_reply_to_link(); ?></small></h3>

		<form id="new-post" class="bbpkr-replyform" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit"><?php _e( 'Submit Reply', 'bbpresskr' ); ?></button>
...
<?php
remove_filter( 'bbp_use_wp_editor', '__return_false', 88.888 );
